### Important
Description:
  I built a model for Face Detection using YOLOv8. Then i exported YOLOv8 model to engine format. As a result, when we predicted the video through the TensorRT model, the FPS went up to 170.
